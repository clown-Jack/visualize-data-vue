  ...
  <div class="pyramid-container">
    ...
    >
      <div class="detail_txt" :class="`detail_txt${index + 1}`">
        <div class="precent_txt" :class="`precent_txt${index + 1}`">
          <div class="charts" :id="`charts${index + 1}`"></div>
        </div>
        <div class="txt_right">
          <div class="legend_contain">
            <div
              class="f_div"
              :class="{
                aharrow_down: index == 0 || index == 1,
                aharrow_up: index == 2 || index == 3
              }"
            >
              {{ item.post }}
            </div>
    ...
    .detail
      ...
      .detail_txt
        ...
        .precent_txt
          ...
          display inline-block
          &.precent_txt1
            background url(../../assets/image/img/chart2/icon_xfq04.png) no-repeat center
          &.precent_txt2
            background url(../../assets/image/img/chart2/icon_xfq03.png) no-repeat center
          &.precent_txt3
            background url(../../assets/image/img/chart2/icon_xfq01.png) no-repeat center
          &.precent_txt4
            background url(../../assets/image/img/chart2/icon_xfq02.png) no-repeat center
          .charts
            width 100%
            height 100%
        .txt_right
          ...
          .legend_contain
            ...
            .f_div
              ...
              &.aharrow_down
                &:before
                  @extend $arrow_icon
                  background: url(../../assets/image/img/chart2/icon_jt01.png) no-repeat center;
              &.aharrow_up {
                &:before {
                  @extend $arrow_icon;
                  background: url(../../assets/image/img/chart2/icon_jt02.png) no-repeat center;
                }
              }
            .s_div
              font-size 16px

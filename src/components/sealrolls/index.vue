<template>
  <div class="sealrolls-container sn-container">
    <div class="sn-conntain">
      ...
      <div class="sn-body">
        <div class="table">
          ...
          <vueSeamlessScroll class="seamless-warp" :data="listData">
...
import vueSeamlessScroll from "../seamlessScrolls";

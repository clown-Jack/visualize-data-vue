      ...
      <div class="sn-body">
        <div class="chart">
          <div class="compass">
            ...
            <div
              class="compass-text"
              :class="[`compass-text-${index + 1}`, { show: number == index }]"
...
export default {
  ...
  setup() {
    ...
    const initData = () => {
      state.number = state.number == state.arr.length ? 0 : state.number;
  ...
  .sn-conntain
    ...
    .sn-title
      ...
      &:before {
        ...
        width 14px
        height 14px
        background url(../../assets/image/img/sn-title.png) no-repeat 0% 0%
      }
    .chart
      position absolute
      width: 500px;
      ...
      .compass
        ...
        .compass-bg-c-1 {
          width: 100%;
          height: 100%;
          background: url(../../assets/image/img/chart1/compass-bg-1.png) no-repeat 50% 345px;
        }
        .compass-bg-c-2 {
          width: 100%;
          height: 100%;
          background: url(../../assets/image/img/chart1/compass-bg-2.png) no-repeat 65% 146px;
          opacity: 0.8;
        }
        .compass-bg-c-3 {
          width: 100%;
          height: 100%;
          background: url(../../assets/image/img/chart1/compass-bg-3.png) no-repeat 50% 227px;
        }
        .compass-bg-c-4 {
          width: 100%;
          height: 100%;
          background: url(../../assets/image/img/chart1/compass-bg-4.png) no-repeat 50% 63px;
        }
        .compass-text {
          position: absolute;
          overflow: hidden;
        ...
        .line-sx {
          ...
          .line-fs {
            width: 14px;
            height: 100%;
            background: url(../../assets/image/img/chart1/line-fs.png) no-repeat;
            background-position: 50% 150%;
            position: absolute;
            z-index: -1;
